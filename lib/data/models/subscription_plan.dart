class SubscriptionPlan {
  ...
  static const List<SubscriptionPlan> defaultPlans = [
    ...
    SubscriptionPlan(
      ...
      priceINR: 199.0,
      priceUSD: 3.99,
      formattedPriceINR: '₹199',
      formattedPriceUSD: '\$3.99',
    ),
    SubscriptionPlan(
      id: 'plan_6_month',
      title: '6 Months Pass',
      ...
      priceINR: 399.0,
      priceUSD: 7.99,
      formattedPriceINR: '₹399',
      formattedPriceUSD: '\$7.99',
    ),
    SubscriptionPlan(
      id: 'plan_12_month',
      title: '1 Year Pass',
      ...
      priceINR: 749.0,
      priceUSD: 11.99,
      formattedPriceINR: '₹749',
      formattedPriceUSD: '\$11.99',
    ),
  ];
}
